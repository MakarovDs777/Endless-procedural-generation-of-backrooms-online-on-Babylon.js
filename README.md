Тема созданна на [Endless backrooms in Babylon.js! - Demos and projects - Babylon.js](https://forum.babylonjs.com/t/endless-backrooms-in-babylon-js/55544/45) но потом мои аккаунт удалили, и теперь пришлось писать всё здесь.

# Предисловие 

Сколько было попыток создать бэкрумс, и хочу отметить что до сих пор так никому, и не удалось полноценно реализовать идею бэкрумса! Ведь что такое бэкрумс!? Бэкрумс это в первую очередь идея бесконченого лабиринта куда что-то, или кто-то случайно выпадает из реальности, и попадает в этот бесконечный лабиринт, и пытается там выжить пытается от туда выбраться, и вся суть в том что тем больше от туда пытаются выбраться тем больше становиться тех кто туда случайно выпадает из реальности, и при каждой последующей итерации того как кто-то от туда выбирается это место становиться все более сломанным, и тем больше выбраться оттуда становиться всё более сложнее, и в конечном итоге окажется так что весь мир, а то и вся вселенная навечно провалится в бэкрумс, и все будут бесконечно блуждать в бесконечном лабиринте бесконечно долго.

# Версия ПК 

Я создал бэкрумс на движке babylon, перемещаяться с помощью стрелок ←, →, ↑, ↓ на клавиатуре и мыши.
...
Но просматривая свою версию бэкрумс на своём смартфоне я обнаружил что я не могу перемещаться на нём теперь давайте сделаем стрелки катинки что-бы можно было перемещаться на мобильной версии.
